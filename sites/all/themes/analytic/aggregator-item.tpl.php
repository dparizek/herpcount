...
<div class="feed-item">
  <h3 class="feed-item-title">
    <a href="<?php print $feed_url; ?>" rel="nofollow" target="_blank"><?php print $feed_title; ?></a>
  </h3>

  <div class="feed-item-meta">
  <?php if ($source_url) : ?>
    <a href="<?php print $source_url; ?>" class="feed-item-source" rel="nofollow" target="_blank"><?php print $source_title; ?></a> -
  <?php endif; ?>
